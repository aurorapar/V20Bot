from ..event_handlers.handle_message import handle_message
from ..event_handlers.handle_roll import handle_roll
...
from ..event_handlers.handle_challenge import handle_challenge